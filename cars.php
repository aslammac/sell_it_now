...
<html>
<head>
<title>vehicles : sell it now</title>
				...
				<div class="search-product ads-list">
					...
					<div class="search">
						...
						<div class="input-group">
							<input type="text" class="form-control input-lg" placeholder="BMW" />
						   ...
						   <div>
							...
							<ul class="list">
								<a href="single.html">
									...
									<h5 class="title">lamborghini</h5>
									<span class="adprice">₹70L</span>
								...
								<a href="single.html">
									...
									<section class="list-left">
									<h5 class="title">Volvo</h5>
									<span class="adprice">₹20L</span>
									<p class="catpath">Cars » Other Vehicles</p>
									</section>
									<section class="list-right">
								...
								<a href="single.html">
									...
									<section class="list-left">
									<h5 class="title">Toyota Fortuner</h5>
									<span class="adprice">₹12L</span>
									<p class="catpath">Cars » Other Vehicles</p>
									</section>
									<section class="list-right">
