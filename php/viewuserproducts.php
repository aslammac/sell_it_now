...
<body class="background">
  <div class="layer">
    ...
    <div class="row1">
    <a href="sell.php"><input type="button" value="ADD YOUR PRODUCT"></a></div>
    <div class="rows">
    <?php
	$sql = "SELECT * FROM `sellproduct` WHERE r_uid=".$_SESSION['USERID'];
                ...
                $quantity=$row[3];
                 $price=$row[4];
                    ...
                    <div class="center">
                     ...
                     Available Quantity:<br> '.$quantity.'<br>
                      price/kg: '.$price.'<br><br>
