...
<html>
<head>
<title>Mobiles : Sell it Now</title>
				...
				<div class="search-product ads-list">
					...
					<div class="search">
						...
						<div class="input-group">
							<input type="text" class="form-control input-lg" placeholder="iphone X" />
						   ...
						   <div>
							...
							<ul class="list">
								<a href="single.html">
									...
									<h5 class="title">Samsung S5</h5>
									<span class="adprice">₹12000</span>
									<p class="catpath">Mobile Phones » Brand</p>
									</section>
									<section class="list-right">
									<span class="date">Today, 17:55</span>
									<span class="cityname">Thodupuzha</span>
									</section>
									<div class="clearfix"></div>
									</li> 
								</a>
								<a href="single.html">
									...
									<section class="list-left">
									<h5 class="title">Essential Phone</h5>
									<span class="adprice">₹17000</span>
									<p class="catpath">Mobile Phones » Brand</p>
									</section>
									<section class="list-right">
								...
								<a href="single.html">
									...
									<section class="list-left">
									<h5 class="title">Sony Xperia M</h5>
									<span class="adprice">₹8500</span>
									<p class="catpath">Mobile Phones » Brand</p>
									</section>
									<section class="list-right">
								...
								<a href="single.html">
									...
									<section class="list-right">
									<span class="date">Today, 17:45</span>
									<span class="cityname">Malappuram</span>
									</section>
									<div class="clearfix"></div>
									</li> 
								</a>
								<a href="single.html">
									...
									<section class="list-right">
									<span class="date">Today, 17:30</span>
									<span class="cityname">Thrissur</span>
									</section>
									<div class="clearfix"></div>
									</li> 
								</a>
